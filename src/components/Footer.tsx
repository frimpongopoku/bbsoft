      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
            We deliver cutting-edge web, mobile, and software solutions, custom-built for high performance, visual beauty, and seamless usability.
          </p>
          <div className="flex items-center gap-3 mt-2">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-900 hover:bg-slate-800 hover:text-brand-orange transition-colors" aria-label="GitHub">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />
                <path d="M9 18c-4.51 2-5-2-7-2" />
              </svg>
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-900 hover:bg-slate-800 hover:text-brand-orange transition-colors" aria-label="LinkedIn">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-slate-900 hover:bg-slate-800 hover:text-brand-orange transition-colors" aria-label="Twitter">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Contact info column */}
        <div>
          <h3 className="font-bold text-white tracking-widest uppercase text-xs mb-4">Registry & Location</h3>
          <address className="not-italic flex flex-col gap-4 text-sm">
            <div className="flex items-start gap-2.5">
              ...
              <span className="text-slate-300 leading-relaxed">
                <strong>Biibisoft Ghana Ltd.</strong><br />
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a href="mailto:message@biibisoft.com" className="hover:text-brand-orange transition-colors">message@biibisoft.com</a>
            </div>
          </address>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="inline-block w-3.5 h-2.5 relative rounded-xs overflow-hidden border border-slate-800">
            <span className="absolute inset-y-0 left-0 w-1/3 bg-[#ffd200]" />
            <span className="absolute inset-y-0 right-0 w-1/3 bg-[#dd0000]" />
            <span className="absolute inset-y-0 left-1/3 w-1/3 bg-[#006b3f]" />
          </span>
        </div>
      </div>
    </footer>
